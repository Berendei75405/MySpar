...
protocol RecommendedProductsTableCellDataSource: AnyObject {
    func fetchRecommendedProduct(index: Int) -> Product
}

class RecommendedProductsTableCell: UITableViewCell {
    static let identifier = "RecommendedProductsTableCell"
    var textForHeader = "Рекомендуем"
    weak var dataSource: RecommendedProductsTableCellDataSource?
...
//MARK: - extension
extension RecommendedProductsTableCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let product = dataSource?.fetchRecommendedProduct(index: indexPath.row)
